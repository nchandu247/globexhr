...
from globex_hr_letters.utils.permissions import employee_query_conditions
...
def test_hooks_py_wires_the_filter():
    ...
    assert "globex_hr_letters.utils.permissions.employee_query_conditions" in source, \
