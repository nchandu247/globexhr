...
Registered in Zoho Sign console as:
  https://gdshr.m.frappe.cloud/api/method/globex_hr_letters.webhooks.zoho_sign.callback
    ...
    try:
        ...
        if operation_type == "RequestCompleted":
            if letter_type == "offer_letter" and docname:
                ...
                frappe.enqueue(
                    "globex_hr_letters.webhooks.zoho_sign._download_and_attach_signed_pdf",
                    queue="short",
                    docname=docname,
