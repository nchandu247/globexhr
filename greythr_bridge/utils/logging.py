...
def get_recent_errors(limit: int = 10, filter_title: str = "greytHR") -> list:
    ...
    Call from a logged-in browser:
        https://<site>/api/method/greythr_bridge.utils.logging.get_recent_errors
        https://<site>/api/method/greythr_bridge.utils.logging.get_recent_errors?limit=20
        https://<site>/api/method/greythr_bridge.utils.logging.get_recent_errors?filter_title=Zoho
    """
